---
description: Distilled reference for creating effective design briefs and bootstrapping design tokens.
version: "1.0.2"
...
- Do NOT inline `DESIGN.md` token values — `DESIGN.md` is supplied to the chosen generator as the Design System.
