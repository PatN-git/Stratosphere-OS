...
_SRC = Path(__file__).resolve().parent.parent / "lifecycle-harness" / "responder.py"
...
FIXTURE = (Path(__file__).resolve().parent.parent / "lifecycle-harness" / "fixture" / "topic.md").read_text(
    encoding="utf-8")
