...
- No finding ≥ 80 → HALT: `[READY] BT-<padded>: specs consistent; proceed to /3b-create-issue.` Write no file.
...
## Phase 5: Handoff
HALT. Output a 2-line summary (findings by severity; docs edited with new versions). Hand to `/3b-create-issue`.
