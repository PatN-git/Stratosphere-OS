...
4. **Fog-or-Flat:** If new map, assess complexity. Single-session and no dependencies → redirect `/1b-concept-framing`; else proceed to Phase 1: Chart.
...
7. **Hand-off:** Expose brief. Trigger `/2a-write-prd` or exit ramps.
